...
const Navbar = (props) => {
    ...
    const render = () => {
        ...
        const styles = scrolled ? "static transition px-4 sm:px-6 lg:px-8 transition pt-2 pb-2 bg-blue-deep box-shadow" : "static pt-6 px-4 sm:px-6 lg:px-8 transition   pt-6 bg-transparent"
        return (
                ...
                <div id="navbar" className={styles}>
                    <nav className="relative flex items-center justify-between sm:h-10  max-w-7xl px-4 sm:px-8 mx-auto" aria-label="Global">
                        ...
                        <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-4">
                            <button onClick={e => goto("init")} className="link-purple font-medium sub4 text-white hover:text-green">Ir al inicio</button>
                            <button onClick={e => goto("i")} className="link-purple font-medium sub4 text-white hover:text-green mr-6">Sobre mí</button>
                            <button onClick={e => goto("books")} className="link-purple font-medium sub4 text-white hover:text-green mr-6 hover:cursor-pointer">Libros</button>
                            <Link href="/">
                                <a className="link-purple font-medium sub4 text-white hover:text-green ">Blog <ExternalLinkIcon className="-ml-1 h-5 w-5 inline-block ml-2"/></a>
                            </Link>
                            <button href="#" onClick={e => goto("talk")} className="btn  btn-sm btn-outline round block md:inline-block text-center " >Comprar </button>

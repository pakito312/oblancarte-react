...
const SoftwareArchitecturePage = (props) => {
    ...
    const hero = () => {
        return (
            <main id="init" className="relative bg-blue-deep xl:book-hero">
                <img src="/patterns/hero-patterns/bubble-1.svg" className="absolute left-0 top-32 " />
                <img src="/patterns/hero-patterns/wave-1.svg" className="absolute left-0 bottom-0 top-0 h-full" />
                <img src="/patterns/hero-patterns/expresion.svg" className="absolute right-20 bottom-1/2" />
                <img src="/patterns/hero-patterns/buuble-2.svg" className="absolute right-0 bottom-0" />
                <div className="layout flex flex-col-reverse md:flex-row h-full md:pt-16">
                    <div className="flex justify-center items-center z-10 flex-1 ">
                        <div className="mb-16 mt-10">
                            <p className=" text-white mb-2 text-xl md:text-3xl lg:text-4xl">Introducción los</p>
                            <h1 className="font-poppins text-white font-bold text-2xl md:text-4xl lg:text-5xl xl:text-6xl mb-4 lg:-mr-40">
                                <Typist cursor={{ hideWhenDone: true }} >Patrones de diseño</Typist>
                            </h1>
                            ...
                            <div className="flex flex-row">
                                ...
                                <div className="">
                                    ...
                                    <p className="sub3 text-sm lg:text-lg text-white font-bold ">Java / C#</p>
                                </div>
                            </div>

                            <p className="body1 text-white mt-8 text-lg text-justify md:text-left md:mr-40">El único libro que te enseñará los patrones de diseño con ejemplos reales del mundo real totalmente en español. Olvídate de los ejemplos de pizzas, figuras geométricas y clase de animales que ladran, maúllan o ladran.</p>
                            <div className="">
                                <Link href="/books/design-patterns/es/checkout">
                    ...
                    <div className="flex flex-wrap justify-center content-end mt-0 flex-1">
                        <div className="h-full lg:h-auto lg:-ml-20 xl:-ml-12">
                            <img src="/books/patrones.png" alt="oscar blancarte" className="block mt-20 md:mt-0 lg:ml-28 w-[40vh] md:w-[40vh] lg:w-[50vh] xl:w-[60vh] mb-[-50px]" />
                        </div>
                    </div>
                </div>
            </main>
            ...
            <div>
                <section className="layout text-center">
                    <div className="max-w-5xl">
                        <div className="box rounded-xl shadow-gray overflow-hidden p-4">
                            <img src="/patterns/waves-white-1.svg" alt="" className="absolute " />
                            <div className="grid grid-cols-5 gap-16">
                                <div className="col-span-2">
                                    <h2 className="text-xl md:text-3xl mb-8">Importancia de los<br />patrones de diseño</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fringilla ac ut aliquet a sit venenatis semper quam tellus. Dignissim semper semper non aenean at sed. Dignissim scelerisque laoreet proin senectus nam porttitor in neque. Aliquet porttitor mauris dui convallis justo. Ut mi, convallis urna libero amet augue sit convallis mauris. Cras sed id scelerisque tellus, dolor pretium egestas aliqua.</p>
                                </div>
                                <div className="col-span-3">
                                    <iframe className="w-full h-full rounded-xl overflow-hidden" data-src="https://www.youtube.com/embed/LNzjA2KiCKU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" src="https://www.youtube.com/embed/LNzjA2KiCKU"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
